...
// Input Path
template void DoubleConv3D2Head<IN_CHANNELS, F_MAP_h, F_MAP_0>(
    data_t[BATCH_SIZE][IN_CHANNELS][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH],
    data_t[F_MAP_h][IN_CHANNELS][CONV_KERNEL][CONV_KERNEL][CONV_KERNEL],
//    data_t[IN_CHANNELS],
//    data_t[IN_CHANNELS],
    data_t[F_MAP_0][F_MAP_h][CONV_KERNEL][CONV_KERNEL][CONV_KERNEL],
//    data_t[F_MAP_h],
//    data_t[F_MAP_h],
    data_t[BATCH_SIZE][F_MAP_0][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH],
    data_t[BATCH_SIZE][F_MAP_0][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH]);
// Encoder Path
template void MaxPool3D<F_MAP_0>(
    data_t[BATCH_SIZE][F_MAP_0][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH],
    data_t[BATCH_SIZE][F_MAP_0][POOL_OUTPUT_DEPTH][POOL_OUTPUT_HEIGHT][POOL_OUTPUT_WIDTH]);
template void DoubleConv3D<F_MAP_0, F_MAP_0, F_MAP_1, POOL_OUTPUT_DEPTH, POOL_OUTPUT_HEIGHT, POOL_OUTPUT_WIDTH>(
    data_t[BATCH_SIZE][F_MAP_0][POOL_OUTPUT_DEPTH][POOL_OUTPUT_HEIGHT][POOL_OUTPUT_WIDTH],
    data_t[F_MAP_0][F_MAP_0][CONV_KERNEL][CONV_KERNEL][CONV_KERNEL],
//    data_t[F_MAP_0],
//    data_t[F_MAP_0],
    data_t[F_MAP_1][F_MAP_0][CONV_KERNEL][CONV_KERNEL][CONV_KERNEL],
//    data_t[F_MAP_0],
//    data_t[F_MAP_0],
    data_t[BATCH_SIZE][F_MAP_1][POOL_OUTPUT_DEPTH][POOL_OUTPUT_HEIGHT][POOL_OUTPUT_WIDTH]);
// Decoder Path
template void Upsample3D<F_MAP_1>(
    data_t[BATCH_SIZE][F_MAP_1][POOL_OUTPUT_DEPTH][POOL_OUTPUT_HEIGHT][POOL_OUTPUT_WIDTH],
    data_t[BATCH_SIZE][F_MAP_1][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH]);
template void ConcatenateTensors<F_MAP_0, F_MAP_1, CONCAT_CHANNELS>(
    data_t[BATCH_SIZE][F_MAP_0][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH],
    data_t[BATCH_SIZE][F_MAP_1][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH],
    data_t[BATCH_SIZE][CONCAT_CHANNELS][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH]);
template void DoubleConv3D<CONCAT_CHANNELS, F_MAP_0, F_MAP_0>(
    data_t[BATCH_SIZE][CONCAT_CHANNELS][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH],
    data_t[F_MAP_0][CONCAT_CHANNELS][CONV_KERNEL][CONV_KERNEL][CONV_KERNEL],
//    data_t[CONCAT_CHANNELS],
//    data_t[CONCAT_CHANNELS],
    data_t[F_MAP_0][F_MAP_0][CONV_KERNEL][CONV_KERNEL][CONV_KERNEL],
//    data_t[F_MAP_0],
//    data_t[F_MAP_0],
    data_t[BATCH_SIZE][F_MAP_0][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH]);
// Output Path
template void DoubleConv3D<F_MAP_0, F_MAP_0, F_MAP_0>(
    data_t[BATCH_SIZE][F_MAP_0][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH],
    data_t[F_MAP_0][F_MAP_0][CONV_KERNEL][CONV_KERNEL][CONV_KERNEL],
//    data_t[F_MAP_0],
//    data_t[F_MAP_0],
...
//    data_t[F_MAP_0],
    data_t[BATCH_SIZE][F_MAP_0][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH]);
template void FinalConv1x1<F_MAP_0, OUT_CHANNELS>(
    data_t[OUT_CHANNELS][F_MAP_0][1][1][1],
    data_t[OUT_CHANNELS],
    data_t[BATCH_SIZE][F_MAP_0][INPUT_DEPTH][INPUT_HEIGHT][INPUT_WIDTH],
...
template<int T_IN_CHANNELS>
void MaxPool2D(data_t input[BATCH_SIZE][T_IN_CHANNELS][INPUT_HEIGHT][INPUT_WIDTH],
               data_t output[BATCH_SIZE][T_IN_CHANNELS][POOL_OUTPUT_HEIGHT][POOL_OUTPUT_WIDTH]) {
    #pragma HLS array_partition variable=input cyclic factor=T_IN_CHANNELS dim=2
    #pragma HLS array_partition variable=output cyclic factor=T_IN_CHANNELS dim=2
